...
public class Level_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_lvl.setText(R.string.level_2);
        TextView lvl_desc = (TextView) findViewById(R.id.lvl_description);
        final Animation animation = AnimationUtils.loadAnimation(Level_2.this, R.anim.alpha);
        ...
        if (chooseCard) {
            btn_left.setImageResource(array.images2[numLeft]);
            btn_right.setImageResource(array.images2[numRight]);
            flag = 1;
        } else {
            btn_left.setImageResource(array.images2[numRight]);
            btn_right.setImageResource(array.images2[numLeft]);
            flag = 2;
        }
