...
public class    Level_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_lvl.setText(R.string.level_3);
        TextView lvl_desc = (TextView) findViewById(R.id.lvl_description);
        final Animation animation = AnimationUtils.loadAnimation(Level_3.this, R.anim.alpha);
        ...
        lvl_desc.setText(array.text3[numLeft]);
        numRight = random.nextInt(length);
        while (numLeft == numRight) {
            numRight = random.nextInt(length);
        }

        btn_left.setImageResource(R.drawable.no);
        btn_right.setImageResource(R.drawable.yes);
...
//            flag = 1;
//        } else {
//           btn_left.setImageResource(R.drawable.yes);
//           btn_right.setImageResource(R.drawable.no);
//            flag = 2;
//        }
