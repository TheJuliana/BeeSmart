...
public class Level_5  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_lvl.setText(R.string.level_5);
        TextView lvl_desc = (TextView) findViewById(R.id.lvl_description);
        final Animation animation = AnimationUtils.loadAnimation(Level_5.this, R.anim.alpha);
        ...
        lvl_desc.setText(array.text5[numLeft]);
        ...
        if (chooseCard) {
            btn_left.setImageResource(array.images5[numLeft]);
            btn_right.setImageResource(array.images5[numRight]);
            flag = 1;
        } else {
            btn_left.setImageResource(array.images5[numRight]);
            btn_right.setImageResource(array.images5[numLeft]);
            flag = 2;
        }
