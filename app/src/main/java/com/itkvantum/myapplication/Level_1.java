...
public class Level_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_to_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Button sound_on = findViewById(R.id.sound_on);
                    ...
                    Button sound_off = findViewById(R.id.sound_off);
        ...
        name_lvl.setText(R.string.level_1);
        ...
        lvl_desc.setText(array.text1[numLeft]);
        ...
        if (chooseCard) {
            btn_left.setImageResource(array.images1[numLeft]);
            btn_right.setImageResource(array.images1[numRight]);
            flag = 1;
        } else {
            btn_left.setImageResource(array.images1[numRight]);
            btn_right.setImageResource(array.images1[numLeft]);
            flag = 2;
        }
